...
//  Copyright (c) 2015-2016 Jean Guyomarc'h. All rights reserved.
//
...
_pud_to_image(const Pud *pud)
{
    ...
    map = pud_minimap_bitmap_generate(pud, &map_size, PUD_PIXEL_FORMAT_RGBA);
    if (NULL == map) {
